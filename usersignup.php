...
$message .= '<a href="http://mrinalini.esy.es/activate.php?account='.$username.'">clickme</a>';
$message .= '</body></html>';

                        if(mail($to, $subject, $message, $headers)){
    echo 'Your account activation link ........';
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>	
	...
	<body>
	<div class="navdiv">
	<p style=" color:#fff; ">Saanvi Varna</p>
	</div>
...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="password" name="password" class="form-control" id="password" placeholder="at least 6 characters ">
    </div><br><br>
